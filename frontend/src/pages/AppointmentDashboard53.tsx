        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              The ANC Apprentice Program provides hands-on training, mentorship, and
              real-world experience in e-commerce, business operations, and digital
              marketing. Schedule your intake appointment below.
            </p>
