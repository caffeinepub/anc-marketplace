        ...
        <div className="flex items-center justify-center py-12">
          <Card className="max-w-md w-full border-emerald-200">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Your deposit was successful. Funds have been added to your Stripe account
                and your ledger has been updated.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-lg bg-emerald-50 border border-emerald-200 p-4 text-sm text-emerald-800 space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <p>Real funds have been deposited into your Stripe account (currency: USD).</p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" />
                  <p>You can verify the balance in your Stripe Dashboard at dashboard.stripe.com.</p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-600 mt-0.5 shrink-0" />
                  <p>Your deposit ledger has been updated with this transaction record.</p>
                </div>
              </div>

              <div className="flex flex-col gap-2">
                <Button
                  onClick={() => navigate({ to: '/admin', search: { tab: 'financial' } as any })}
                ...
                <Button
                  variant="outline"
                  onClick={() => navigate({ to: '/admin', search: { tab: 'transactions' } as any })}
                  className="w-full"
                >
                  View Transactions
                </Button>
