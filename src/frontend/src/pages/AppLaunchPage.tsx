...
import { ArrowLeft, ExternalLink, Info, Settings, Trash2 } from "lucide-react";
...
function AppLaunchContent() {
  ...
  > = {
    clickfunnels: {
      ...
      longDescription:
        "ClickFunnels is a powerful marketing platform that helps you build sales funnels, landing pages, and marketing campaigns. Integrate with your ANC Marketplace store to drive more sales.",
      status: "active",
    ...
    dropshipping: {
      ...
      longDescription:
        "Access a network of trusted dropshipping suppliers to expand your product catalog without holding inventory. Automate order fulfillment and focus on growing your business.",
      status: "configured",
    },
    "template-selector": {
      ...
      longDescription:
        "Browse and select from a variety of professionally designed store templates. Customize colors, layouts, and branding to match your business identity.",
      status: "installed",
    },
  };
  ...
  const appConfig = appConfigs[appId] || {
    ...
    longDescription:
      "This app is not available or has not been configured yet.",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <div
                    className={`px-3 py-1 rounded-full text-sm font-medium ${
                      appConfig.status === "active"
                        ...
                        : appConfig.status === "configured"
                          ? "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                          : "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"
                    }`}
                  >
                    {appConfig.status.charAt(0).toUpperCase() +
                      appConfig.status.slice(1)}
                  </div>
                </div>
              </div>
            </CardHeader>
          ...
          <Alert className="mt-6">
            ...
            <AlertDescription>
              App launch and configuration features are currently in
              development. Full functionality will be available soon. Contact
              support for assistance with app integration.
            </AlertDescription>
          </Alert>
        </div>
      </div>
