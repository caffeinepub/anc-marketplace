      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Convert your marketplace store into a standalone website or mobile
            app
          </p>
        </div>
        ...
        <Card className="border-2 border-primary">
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                <strong>Free marketplace access is included</strong> — Store
                Builder is an optional $10/month upgrade for sellers who want a
                standalone website or app.
              </AlertDescription>
            </Alert>
              ...
              {[
                {
                  ...
                  desc: "Select from professional website templates",
                },
                {
                  step: "2",
                  label: "Customize branding",
                  desc: "Add your logo, colors, and content",
                },
                {
                  step: "3",
                  label: "Connect domain",
                  desc: "Link your custom domain name",
                },
                {
                  step: "4",
                  label: "Go live",
                  desc: "Publish your standalone website",
                },
              ].map((item) => (
                <div
                  key={item.step}
              ...
              {[
                {
                  ...
                  desc: "Set app name, icon, and splash screen",
                },
                {
                  step: "2",
                  label: "Design app screens",
                  desc: "Customize the look and feel of your app",
                },
                {
                  step: "3",
                  label: "Test on devices",
                  desc: "Preview on iOS and Android simulators",
                },
                {
                  step: "4",
                  label: "Submit to stores",
                  desc: "Publish to App Store and Google Play",
                },
              ].map((item) => (
                <div
                  key={item.step}
