        ...
        <Card className="border-2 border-primary">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Create powerful sales funnels to convert visitors into
                  customers
                </CardDescription>
              </div>
            </div>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              ANC Marketplace has partnered with ClickFunnels to give you access
              to professional funnel-building tools. Sign up through our
              affiliate link to get started and support the marketplace.
            </p>
            ...
            <Alert>
              ...
              <AlertDescription>
                Using our affiliate link helps support ANC Marketplace at no
                extra cost to you.
              </AlertDescription>
            </Alert>
          </CardContent>
          ...
          {[
            {
              title: "Sales Funnels",
              description:
                "Build multi-step funnels that guide customers to purchase",
            },
            {
              title: "Landing Pages",
              description:
