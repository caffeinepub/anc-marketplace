      ...
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            ...
            vary based on destination and selected method.
          </p>

          <h2>2. Shipping Costs</h2>
          <p>
            Shipping costs are calculated at checkout based on order weight,
          ...
          <p>
            We ship to select international destinations. Additional customs
            fees and duties may apply.
          </p>
