    ...
    <div className="container mx-auto px-4 py-8">
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            Digital products, personalized items, and clearance items are not
            eligible for return.
          </p>

          <h2>3. Return Process</h2>
          <p>
            Contact us at ancelectronicsnservices@gmail.com to initiate a
            return. You will receive return instructions and a return
