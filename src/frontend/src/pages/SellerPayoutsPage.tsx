...
function SellerPayoutsContent() {
  ...
  const handleDebitCardRequest = async (e: React.FormEvent) => {
    ...
    toast.success(
      "Debit card request submitted. We'll review your application.",
    );
  };
  ...
  const handleCreditCardApplication = async (e: React.FormEvent) => {
    ...
    toast.success(
      "Credit card application submitted. We'll review your application.",
    );
  };
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Alert className="mt-4">
              ...
              <AlertDescription>
                Funds are held until a payout account is configured and
                verified.
              </AlertDescription>
            </Alert>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set your designated payout account number
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Request a business debit card for your account
            </CardDescription>
          </CardHeader>
          <CardContent>
