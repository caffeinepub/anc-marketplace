            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-80 overflow-y-auto">
                ...
                <nav className="flex flex-col gap-4 mt-6">
                  ...
                  {isAuthenticated && isAdmin && (
                    <div className="border-t pt-4 mt-2">
                      <p className="text-xs font-semibold text-primary mb-2">ADMIN</p>
                      <div className="flex flex-col gap-2">
                        <button
                    ...
                    <div className="border-t pt-4 mt-2">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <button
                          ...
                          className="text-sm text-destructive hover:text-destructive/80 transition-colors text-left"
                        >
                          Logout
                        </button>
                      </div>
      ...
      <footer className="border-t border-border bg-muted/30 mt-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-semibold mb-3 text-primary">About</h3>
              <p className="text-sm text-muted-foreground">
                ANC Electronics N Services - Building the bridge to success for entrepreneurs and businesses.
              </p>
            </div>
            <div>
