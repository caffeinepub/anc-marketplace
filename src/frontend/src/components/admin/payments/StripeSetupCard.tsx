      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Primary payment processor for marketplace transactions
            </CardDescription>
          </div>
          {isConfigured ? (
            <Badge
        ...
        {isConfigured && !showForm ? (
          <div className="space-y-3">
            <Alert>
              ...
              <AlertDescription>
                Stripe is configured with your live keys and ready to process
                payments.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Live secret key is configured and active.
              </p>
            </div>
