    ...
    <Card>
      ...
      <CardContent>
        <Alert className="mb-4">
          ...
          <AlertDescription>
            Employee payment tracking is simulated. Backend integration for
            payment processing is on the roadmap.
          </AlertDescription>
        </Alert>
        ...
        <Tabs defaultValue="manual" className="w-full">
          ...
          <TabsContent value="scheduled" className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                Scheduled payments are stored but not automatically executed.
