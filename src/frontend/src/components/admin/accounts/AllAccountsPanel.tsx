...
export default function AllAccountsPanel() {
  ...
  const _formatCurrency = (cents: bigint): string => {
  ...
  const getRoleBadge = (role: string) => {
    const roleColors: Record<string, string> = {
      admin:
        "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-950 dark:text-purple-400",
      seller:
        "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-950 dark:text-blue-400",
      customer:
        "bg-emerald-100 text-emerald-800 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-400",
      business:
        "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-950 dark:text-amber-400",
      marketer:
        "bg-pink-100 text-pink-800 border-pink-200 dark:bg-pink-950 dark:text-pink-400",
      employee:
        "bg-cyan-100 text-cyan-800 border-cyan-200 dark:bg-cyan-950 dark:text-cyan-400",
      guest:
        "bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-950 dark:text-gray-400",
    };
                ...
                <TableBody>
                  {filteredUsers.map((user) => (
                    <TableRow key={user.principal.toString()}>
                      ...
                      <TableCell>
                        {getRoleBadge(user.profile.activeRole)}
                      </TableCell>
                      <TableCell>
