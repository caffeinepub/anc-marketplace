...
export const onboardingSteps: OnboardingStepConfig[] = [
  {
    ...
    title: "Introduction",
    description:
      "Welcome to ANC Marketplace seller onboarding. Learn what to expect in the process.",
    isPlaceholder: false,
  },
  {
    ...
    description:
      "Provide your business information and verify your identity (coming next).",
    isPlaceholder: true,
  },
  {
    ...
    title: "Store Profile",
    description:
      "Create your store profile with name, description, and branding (coming soon).",
    isPlaceholder: true,
  },
  {
    ...
    description:
      "Connect your store to external platforms and tools (future step).",
    isPlaceholder: true,
  },
  {
    ...
    title: "Store Setup",
    description:
      "Configure your storefront and choose templates (future step).",
    isPlaceholder: true,
  },
  {
    ...
    title: "Marketing",
    description:
      "Set up marketing tools and promotional campaigns (future step).",
    isPlaceholder: true,
  },
];
